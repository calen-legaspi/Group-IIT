...
public class Product implements Serializable {
	...
	private static final long serialVersionUID = 5242397417262957881L;
	...
	public Product(String name, BigDecimal amount)
			throws IllegalArgumentException {
		if (name == null || name.equals("") || amount == null
				|| amount.compareTo(BigDecimal.ZERO) == 0) {
			throw new IllegalArgumentException(
					"One of the parameter is null or contains an illegal value.");
		}
		this.name = name;
		this.amount = amount;
	}
	...
	/**
	 * Use this to reconstruct a Product instance from a database.
	 * 
	 * @param skuNumber
	 ...
	 */
	public Product(int skuNumber, String name, BigDecimal amount)
			throws IllegalArgumentException {
		this(name, amount);
		if (skuNumber == 0) {
	 ...
	 * 
	 * @param amount
	 *            The new unit price that you want to change this amount into.
	 * @throws IllegalArgumentException
	 *             Throws this exception when the parameter is null, zero, or
	 *             negative.
	 */
	public void setAmount(BigDecimal amount) throws IllegalArgumentException {
		if (amount == null || amount.compareTo(BigDecimal.ZERO) >= 0) {
			throw new IllegalArgumentException(
					"Amount cant be null, zero, or negative.");
		}
		this.amount = amount;
	}
	 ...
	 * @throws IllegalArgumentException
	 *             Throws this exception when the parameter is empty/null.
	 */
	...
	/**
	 * @return The stock-keeping unit number. This uniquely identifies a
	 *         product. Equality operations are dependent on this.
	 */
