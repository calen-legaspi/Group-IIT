...
public class InventoryItem implements Serializable {
	 ...
	 *             if the id was not yet generated by the system.
	 */
	public int getId() throws IllegalStateException {
		if (id == 0) {
			throw new IllegalStateException(
					"Id not yet generated at this state. Id generated after insertion.");
		}
		return id;
	}
	 ...
	 *                Throws this exception when the quantity is less than zero.
	 */
	...
	public boolean equals(Object o) {
		if (!(o instanceof InventoryItem)) {
			throw new IllegalArgumentException(
					"Parameter is not an InventoryItem");
		}
	 ...
	 * @return
	 * @throws IllegalArgumentException
	 *             if the orderitem does not contain any product or is not of
	 *             the same kind.
	 */
	 ...
	 */
	public void removeQuantityByOrderItem(OrderItem orderItem)
			throws DomainException {
		throw new UnsupportedOperationException();
	}
}
