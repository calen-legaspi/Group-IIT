 ...
 */
public class InventoryItemDaoJdbcImpl extends AbstractDao implements InventoryItemDao {
     ...
     */
    public InventoryItemDaoJdbcImpl(Connection connection) throws IllegalArgumentException {
        super(connection);
    }
