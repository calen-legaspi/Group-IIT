...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
    <head>
        ...
        <title>O&amp;B Ordering System</title>
    ...
    <body>
        ...
        <div id="art-main">
            <div class="art-Sheet">
                ...
                <div class="art-Sheet-body">
                    <div class="art-Header">
                        ...
                        <div class="art-Logo">
                            <h1 id="name-text" class="art-Logo-name"><a href="#">O&amp;B Ordering System</a></h1>
                            <div id="slogan-text" class="art-Logo-text">Ordering items done right!</div>
                        </div>
                    </div>
                    <div class="art-nav">
                        <div class="l"></div>
                        ...
                        <ul class="art-menu">
                            ...
                            <li>
                                <a href="#"><span class="l"></span><span class="r"></span><span class="t">Create Order</span></a>
                            </li>	
                            <li>
                                <a href="#"><span class="l"></span><span class="r"></span><span class="t">Payment</span></a>
                            </li>
                            <li>
                                <a href="#"><span class="l"></span><span class="r"></span><span class="t">Customer History</span></a>
                            </li>
                            <li>
            ...
            <div class="cleared"></div>
            <p class="art-page-footer">Designed by <a href="http://www.facebook.com/draculemihawk">Lyndon Michael C. Bibera</a>.</p>
        </div>
